...
class TestTarifa(unittest.TestCase):
	...
	def test_atributos_son_decimal(self):
		...
		self.assertEqual(type(self.tarifa.tarifa_entre_semana), Decimal, 'tarifa_entre_semana debe ser de tipo decimal')
		self.assertEqual(type(self.tarifa.tarifa_fin_semana), Decimal, 'tarifa_fin_semana debe ser de tipo decimal')
